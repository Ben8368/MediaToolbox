...
export const renderPsdTemplate = forwardMethod('renderPsdTemplate')
export const savePsdManifest = forwardMethod('savePsdManifest')
export const loadPsdManifest = forwardMethod('loadPsdManifest')
