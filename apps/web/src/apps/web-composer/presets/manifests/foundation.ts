...
const slots = collectSlots([
  ...
  textSlot({ id: 'brand.logo', label: '品牌星标', group: '悬浮导航', value: '✦', fontRole: 'heading', allowIcon: false, canHide: false }),
  ...
  textSlot({ id: 'hero.heading.line1', label: '标题第一行', group: '主视觉', value: 'Foundation of the', fontRole: 'heading', allowImage: true, canHide: false }),
  textSlot({ id: 'hero.heading.line2', label: '标题第二行', group: '主视觉', value: 'new digital epoch', fontRole: 'heading', allowImage: true, canHide: false }),
  textSlot({
    id: 'hero.subtext',
    label: '副标题',
    group: '主视觉',
