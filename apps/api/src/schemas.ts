export const fetchTaskSubmitSchema = {
  body: {
    ...
    properties: {
      ...
      mode: { type: 'string', enum: ['video', 'audio', 'subtitles'] },
      output_dir: { type: 'string', minLength: 1 },
      compatible_format: { type: 'boolean' },
      max_concurrent: { type: 'number', minimum: 1, maximum: 4 },
      cookies_from_browser: { type: 'string', enum: ['chrome', 'edge', 'safari', 'firefox'] },
    },
